...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    module.exports = factory(require('./ApiClient'), require('./Configuration'), require('./model/GetAllStats'), require('./model/GetStatsByState'), require('./model/Status'), require('./api/HealthcheckApi'), require('./api/StatsApi'));
  }
}(function(ApiClient, Configuration, GetAllStats, GetStatsByState, Status, HealthcheckApi, StatsApi) {
  'use strict';
