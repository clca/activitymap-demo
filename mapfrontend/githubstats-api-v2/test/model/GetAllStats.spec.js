...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GithubstatsApi.GetAllStats();
  });
  ...
  describe('GetAllStats', function() {
    it('should create an instance of GetAllStats', function() {
      // uncomment below and update the code to test GetAllStats
      //var instane = new GithubstatsApi.GetAllStats();
      //expect(instance).to.be.a(GithubstatsApi.GetAllStats);
    });
